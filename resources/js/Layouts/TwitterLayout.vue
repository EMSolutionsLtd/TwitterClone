    ...
    <div class="fixed w-full">
        <div class="max-w-[1400px] flex mx-auto">
            <div class="lg:w-3/12 w-[60px] h-[100vh] max-w-[350px] lg:px-4 lg:mx-auto">
                ...
                <MenuItem iconString="Home"></MenuItem>
                <MenuItem iconString="Explore"></MenuItem>
                <MenuItem iconString="Notifications"></MenuItem>
                <MenuItem iconString="Messages"></MenuItem>
                <MenuItem iconString="Profile"></MenuItem>
            ...
            <div class="lg:block hidden lg:w-4/12 h-screen border-l border-gray-700 pl-4">
                ...
                <div class="w-full mt-4 rounded-lg lg:block hidden bg-[#212327]">
                    ...
                    <div class="h-[80px] hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between h-[80px] py-3">
                            <div>
                                <div class="text-[14px] text-gray-400">Tennis Tournament</div>
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                <div class="text-[14px] text-gray-400">Trending in UK</div>
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                ...
                                <div class="text-[14px] text-gray-400">98,923 Tweets</div>
                            </div>
                            <DotsHorizontal fillColor="#5e5c5c" />
                        </div>
                    </div>
        ...
        <div class="md:max-w-2xl md:mx-auto md:mt-10 md:rounded-xl bg-black">
            ...
            <div class="w-full flex">
                <div class="ml-3.5 mr-2">
                    <img class="rounded-full" width="55" :src="randImg1" src="" alt="">
                </div>
